...
if __name__ == "__main__":
    ...
    # inpainting options
    argparser.add_argument("--num_inpaints", type=int, default=20, help="Number of inpaints for each input fragment for subsampling.")
    argparser.add_argument("--num_inpaint_cycles", type=int, default=10, help="Number of inpainting recycles to run for each inpainting.")
    argparser.add_argument("--translation_sampling_magnitude", type=float, default=0.05, help="Magnitude of random translation of fragments for randomized sampling during inpainting.")
    argparser.add_argument("--rotation_sampling_degrees", type=float, default=0.5, help="Degrees. How much to rotate fragments during inpainting.")
    argparser.add_argument("--inpaint_rmsd_weight", type=float, default=1, help="Weight of inpainting RMSD score for filtering sampled inpaints.")
    ...
    argparser.add_argument("--total_flanker_length", type=int, default=None, help="Overwrites contig output of 'run_ensemble_evaluator.py'. Set the max length of the pdb-file that is being inpainted. Will only be used in combination with 'flanking'")
