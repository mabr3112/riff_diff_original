...
def main(args):
    ...
    # RFdiffusion:
    diffusion_options = f"diffuser.T={str(args.rfdiffusion_timesteps)} potentials.guide_scale={args.rfdiff_guide_scale} inference.num_designs={args.num_rfdiffusions} potentials.guiding_potentials=[\\'type:substrate_contacts,weight:0\\',\\'type:substrate_motif_contacts,weight:{args.pot_weight},cen_weight:{args.cen_weight},pos_weight:{args.pos_weight},neg_weight:{args.neg_weight}\\'] potentials.guide_decay={args.guide_decay}"
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--neg_weight", type=float, default=2, help="Repulsive substrate weight")
    argparser.add_argument("--pos_weight", type=float, default=10, help="Attractive substrate weight")
    argparser.add_argument("--cen_weight", type=float, default=0, help="Attractive substrate weight")
    ...
    # mpnn options
    argparser.add_argument("--num_mpnn_inputs", type=int, default=100, help="Number of input backbones to ProteinMPNN before predicting them with ESMFold")
