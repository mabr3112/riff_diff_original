...
if __name__ == "__main__":
    ...
    argparser.add_argument("--protocol", type=str, default='/home/mabr3112/riff_diff/rosetta/analysis.xml', help="path to xmlfile that should be used for analysis")
    argparser.add_argument("--rotprob_protocol", type=str, default='/home/mabr3112/riff_diff/rosetta/rotamer_probabilities.xml', help="path to xmlfile that should be used for analysis")
