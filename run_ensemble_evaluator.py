...
if __name__ == "__main__":
    ...
    argparser.add_argument("--add_channel", type=str, default="/home/mabr3112/riff_diff/utils/polygly_310.pdb", help="If specified, adds the structure specified to the fragment to be used as a 'substrate channel' during diffusion. IMPORTANT!!!  Channel pdb-chain name has to be 'Q' ")
